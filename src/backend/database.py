    ...
    if announcements_collection.count_documents({}) == 0:
        for announcement in initial_announcements:
            announcements_collection.insert_one(
                {"_id": announcement["id"], **announcement["details"]})
...
initial_announcements = [
    {
        "id": "welcome-window-2026",
        "details": {
            "message": "Registration support desk is open in the library weekdays from 3:00 PM to 5:00 PM.",
            "starts_at": None,
